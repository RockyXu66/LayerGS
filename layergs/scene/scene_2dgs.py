...
from layergs.utils.camera_utils import cameraList_from_camInfos, camera_to_JSON
...
class Scene2DGS:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, load_iteration=None, shuffle=True, resolution_scales=[1.0], ply_path=''):
        ...
        elif os.path.exists(os.path.join(args.source_path, sparse_folder)):
            scene_info = sceneLoadTypeCallbacks["Colmap"](args.source_path, args.images, args.eval, use_original_colmap=use_original_colmap, sparse_folder=sparse_folder)
