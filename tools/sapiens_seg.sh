...
cd ../../.. || exit
SAPIENS_CHECKPOINT_ROOT=/mnt/raid5/yixu/Projects/Tools/sapiens/sapiens_lite_host
...
for ((i=0; i<TOTAL_JOBS; i++)); do
  GPU_ID=$((i % TOTAL_GPUS))
  CUDA_VISIBLE_DEVICES=${VALID_GPU_IDS[GPU_ID]} /home/yixu/Tools/anaconda3/envs/sapiens_lite/bin/python ${RUN_FILE} \
    ${CHECKPOINT} \
